...
export default function EditInterest({ navigation, route }) {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.head_safe}>
                ...
                <SafeAreaView style={styles.edit_interest_container}>
                    <Text style={styles.edit_interest}>edit interests</Text>
                </SafeAreaView>
            </View>
        </View>
    )
